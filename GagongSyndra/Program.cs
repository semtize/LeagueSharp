...
namespace GagongSyndra
{
    class Program
    {
        ...
        static void Game_OnGameLoad(EventArgs args)
        {
			...
			Menu.SubMenu("Drawing").AddItem(new MenuItem("drawDamage", "Calculate damage to target").SetValue(true));
		...
		private static void OnEndScene(EventArgs args)
        {
            if (Menu.Item("drawDamage").GetValue<bool>())
            {
                ...
                {
                    hpi.unit = enemy;
                    hpi.drawDmg(GetComboDamage(enemy, Menu.Item("UseQ").GetValue<bool>(), Menu.Item("UseW").GetValue<bool>(), Menu.Item("UseE").GetValue<bool>(), Menu.Item("UseR").GetValue<bool>()), Color.Yellow);
                }
            }
        }
			 ...
			 try
            {
                if (Menu.Item("drawDamage").GetValue<bool>())
                {
                    if (target != null && !target.IsDead && !myHero.IsDead)
                    {
                        ...
                        Drawing.DrawText(wts[0] - 40, wts[1] + 40, Color.OrangeRed, "Total damage: " + GetComboDamage(target, Menu.Item("UseQ").GetValue<bool>(), Menu.Item("UseW").GetValue<bool>(), Menu.Item("UseE").GetValue<bool>(), Menu.Item("UseR").GetValue<bool>()) + "!");
                        if (GetComboDamage(target, Menu.Item("UseQ").GetValue<bool>(), Menu.Item("UseW").GetValue<bool>(), Menu.Item("UseE").GetValue<bool>(), Menu.Item("UseR").GetValue<bool>()) >= ts.Health)
                        {
                            Drawing.DrawText(wts[0] - 40, wts[1] + 70, Color.OrangeRed, "Status: Killable");
                        }
                        else if (GetComboDamage(target, Menu.Item("UseQ").GetValue<bool>(), Menu.Item("UseW").GetValue<bool>(), Menu.Item("UseE").GetValue<bool>(), Menu.Item("UseR").GetValue<bool>()) < ts.Health)
                        {
                    ...
                    {
                        hpi.unit = enemy;
                        if (GetComboDamage(enemy, Menu.Item("UseQ").GetValue<bool>(), Menu.Item("UseW").GetValue<bool>(), Menu.Item("UseE").GetValue<bool>(), Menu.Item("UseR").GetValue<bool>()) >= enemy.Health)
                        {
                            hpi.drawDmg(GetComboDamage(enemy, Menu.Item("UseQ").GetValue<bool>(), Menu.Item("UseW").GetValue<bool>(), Menu.Item("UseE").GetValue<bool>(), Menu.Item("UseR").GetValue<bool>()), Color.Red);
                        }
                        else
                        {
                            hpi.drawDmg(GetComboDamage(enemy, Menu.Item("UseQ").GetValue<bool>(), Menu.Item("UseW").GetValue<bool>(), Menu.Item("UseE").GetValue<bool>(), Menu.Item("UseR").GetValue<bool>()), Color.Yellow);
